...
const CrearCuenta = () => {
  ...
  const formik = useFormik({
      ...
      validationSchema: Yup.object({
        ...
        password: Yup.string().required('El password es obligatorio').min(6, 'El password debe tener como mínimo 6 caracteres')
      }),
      onSubmit: valores => {
  ...
  return (
    <Layout>
      <div className="md:w-4/5 xl:w-3/5 mx-auto mb-32">
        <h2 className="text-4xl tont-sans font-bold text-gray-800 text-center my-4">
          Crear Cuenta
        </h2>
